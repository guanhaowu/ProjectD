...
while True:
    ...
    _, frame = cap.read()
    # mid
    cv2.putText(frame, "blink: " + str(blink1), (20, 460), font, 2, (255, 255, 0), 2)
    cv2.putText(frame, "blink: " + str(blink2), (520, 460), font, 2, (255, 255, 0), 2)
    cv2.putText(frame, "blink: " + str(blink3), (1000, 460), font, 2, (255, 255, 0), 2)
    # top
    cv2.putText(frame, "blink: " + str(blink4), (20, 130), font, 2, (0, 255, 0), 2)
    cv2.putText(frame, "blink: " + str(blink5), (520, 130), font, 2, (0, 255, 0), 2)
    cv2.putText(frame, "blink: " + str(blink6), (1000, 130), font, 2, (0, 255, 0), 2)
    # bottom
    cv2.putText(frame, "blink  :" + str(blink7), (20, 560), font, 2, (0, 255, 255), 2)
    cv2.putText(frame, "blink  :" + str(blink8), (520, 560), font, 2, (0, 255, 255), 2)
    cv2.putText(frame, "blink  :" + str(blink9), (1000, 560), font, 2, (0, 255, 255), 2)
    ...
    for face in faces:
        ...
        if temple[1] - eye_corner[1] <= -10:
            ...
            if gaze_ratio <= 2:
                cv2.putText(frame, "BottomRIGHT", (1000, 500), font, 2, (0, 0, 255), 3)
                ...
                if blinking_ratio > 5.7:
                    cv2.putText(frame, "BLINKING", (400, 400), font, 7, (255, 0, 0), 2)
                    blink9 += 1;
                #  new_frame[:] = (0, 0, 255)
            elif gaze_ratio > 6:
                #  new_frame[:] = (255, 0, 0)
                cv2.putText(frame, "BottomLEFT", (50, 500), font, 2, (0, 0, 255), 3)
                ...
                cv2.putText(frame, "BottomCENTER", (500, 500), font, 2, (0, 0, 255), 3)
            ...
            if gaze_ratio <= 1:
                cv2.putText(frame, "TopRIGHT", (1000, 30), font, 2, (0, 0, 255), 3)
                ...
                cv2.putText(frame, "TopCENTER", (400, 30), font, 2, (0, 0, 255), 3)
                ...
                cv2.putText(frame, "TopLEFT", (200, 30), font, 2, (0, 0, 255), 3)
            ...
            if gaze_ratio <= 1:
                cv2.putText(frame, "CenterRIGHT", (1000, 320), font, 2, (0, 0, 255), 3)
                ...
                cv2.putText(frame, "CenterCENTER", (400, 320), font, 2, (0, 0, 255), 3)
                ...
                cv2.putText(frame, "CenterLEFT", (100, 320), font, 2, (0, 0, 255), 3)
